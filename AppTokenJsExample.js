...
const SUMSUB_APP_TOKEN = 'sbx:JRuO3yE0qo9LpWpXP9dMUan0.jlFvL9DABbQLLppRYqT7a2PJp2MP6Al3'; // Example: sbx:uY0CgwELmgUAEyl4hNWxLngb.0WSeQeiYny4WEqmAALEAiK2qTC96fBad - Please don't forget to change when switching to production
const SUMSUB_SECRET_KEY = 'KM7z2PJRqpQvnJQsy8r8DlrXNrjP6nmY'; // Example: Hej2ch71kG2kTd1iIUDZFNsO5C1lh5Gq - Please don't forget to change when switching to production
...
async function main() {
  externalUserId = "random-JSToken-" + Math.random().toString(36).slice(2, 9);
  levelName = 'BBM KYC v1';
